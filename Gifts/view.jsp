...
<div  style="position:absolute; left:250px; top:150px;"> <BR><BR><BR><BR><BR>
...
Statement st=con.createStatement();
 rs=st.executeQuery("select fname from image where email='"+email+"' ");%>
...
%>	 <td><a href="viewi.jsp?f1=<%=f1%>"><img src="<%=image%>" width="200" height="200"></a></td>
