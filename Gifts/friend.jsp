...
<div id="ourCompany-bg" align="center" t=>
				<form action="frnd.jsp"><BR><BR><BR><BR><BR><BR>
				<font color="grenn" size="3"><u><b>Adding Friends</b></u></font><BR><BR>
				<font name="Times new Roman">Select Friends&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<select name="frnd">
...
Statement st=con.createStatement();
 rs=st.executeQuery("select email from signup where email!='"+email+"' ");%>
<%while(rs.next())
					{%>
